...
Source0  : http://download.qt.io/official_releases/qt/5.11/5.11.1/submodules/qtnetworkauth-everywhere-src-5.11.1.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GFDL-1.3 GPL-3.0
Requires: qtnetworkauth-lib
Requires: qtnetworkauth-license
BuildRequires : cmake
...
%prep
%setup -q -n qtnetworkauth-everywhere-src-5.11.1
...
%install
export SOURCE_DATE_EPOCH=1530942798
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/qtnetworkauth
cp LICENSE.GPL3 %{buildroot}/usr/share/doc/qtnetworkauth/LICENSE.GPL3
cp LICENSE.GPL3-EXCEPT %{buildroot}/usr/share/doc/qtnetworkauth/LICENSE.GPL3-EXCEPT
cp LICENSE.FDL %{buildroot}/usr/share/doc/qtnetworkauth/LICENSE.FDL
%make_install
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtNetworkAuth/5.11.1/QtNetworkAuth/private/qabstractoauth2_p.h
/usr/include/qt5/QtNetworkAuth/5.11.1/QtNetworkAuth/private/qabstractoauth_p.h
/usr/include/qt5/QtNetworkAuth/5.11.1/QtNetworkAuth/private/qabstractoauthreplyhandler_p.h
/usr/include/qt5/QtNetworkAuth/5.11.1/QtNetworkAuth/private/qoauth1_p.h
/usr/include/qt5/QtNetworkAuth/5.11.1/QtNetworkAuth/private/qoauth1signature_p.h
/usr/include/qt5/QtNetworkAuth/5.11.1/QtNetworkAuth/private/qoauth2authorizationcodeflow_p.h
/usr/include/qt5/QtNetworkAuth/5.11.1/QtNetworkAuth/private/qoauthhttpserverreplyhandler_p.h
...
/usr/lib64/libQt5NetworkAuth.so.5.11
/usr/lib64/libQt5NetworkAuth.so.5.11.1

%files license
%defattr(-,root,root,-)
/usr/share/doc/qtnetworkauth/LICENSE.FDL
/usr/share/doc/qtnetworkauth/LICENSE.GPL3
/usr/share/doc/qtnetworkauth/LICENSE.GPL3-EXCEPT
