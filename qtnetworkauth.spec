...
Version  : 5.15.0
Release  : 21
URL      : https://download.qt.io/official_releases/qt/5.15/5.15.0/submodules/qtnetworkauth-everywhere-src-5.15.0.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.15/5.15.0/submodules/qtnetworkauth-everywhere-src-5.15.0.tar.xz
...
%prep
%setup -q -n qtnetworkauth-everywhere-src-5.15.0
cd %{_builddir}/qtnetworkauth-everywhere-src-5.15.0
...
%install
export SOURCE_DATE_EPOCH=1589474981
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qtnetworkauth
cp %{_builddir}/qtnetworkauth-everywhere-src-5.15.0/LICENSE.FDL %{buildroot}/usr/share/package-licenses/qtnetworkauth/61907422fefcd2313a9b570c31d203a6dbebd333
cp %{_builddir}/qtnetworkauth-everywhere-src-5.15.0/LICENSE.GPL3 %{buildroot}/usr/share/package-licenses/qtnetworkauth/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/qtnetworkauth-everywhere-src-5.15.0/LICENSE.GPL3-EXCEPT %{buildroot}/usr/share/package-licenses/qtnetworkauth/e93757aefa405f2c9a8a55e780ae9c39542dfc3a
%make_install
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtNetworkAuth/5.15.0/QtNetworkAuth/private/qabstractoauth2_p.h
/usr/include/qt5/QtNetworkAuth/5.15.0/QtNetworkAuth/private/qabstractoauth_p.h
/usr/include/qt5/QtNetworkAuth/5.15.0/QtNetworkAuth/private/qabstractoauthreplyhandler_p.h
/usr/include/qt5/QtNetworkAuth/5.15.0/QtNetworkAuth/private/qoauth1_p.h
/usr/include/qt5/QtNetworkAuth/5.15.0/QtNetworkAuth/private/qoauth1signature_p.h
/usr/include/qt5/QtNetworkAuth/5.15.0/QtNetworkAuth/private/qoauth2authorizationcodeflow_p.h
/usr/include/qt5/QtNetworkAuth/5.15.0/QtNetworkAuth/private/qoauthhttpserverreplyhandler_p.h
...
/usr/lib64/libQt5NetworkAuth.so.5.15.0
