...
Version  : 5.12.4
Release  : 15
URL      : https://download.qt.io/official_releases/qt/5.12/5.12.4/submodules/qtnetworkauth-everywhere-src-5.12.4.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.4/submodules/qtnetworkauth-everywhere-src-5.12.4.tar.xz
...
%prep
%setup -q -n qtnetworkauth-everywhere-src-5.12.4
...
%install
export SOURCE_DATE_EPOCH=1561139431
rm -rf %{buildroot}
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtNetworkAuth/5.12.4/QtNetworkAuth/private/qabstractoauth2_p.h
/usr/include/qt5/QtNetworkAuth/5.12.4/QtNetworkAuth/private/qabstractoauth_p.h
/usr/include/qt5/QtNetworkAuth/5.12.4/QtNetworkAuth/private/qabstractoauthreplyhandler_p.h
/usr/include/qt5/QtNetworkAuth/5.12.4/QtNetworkAuth/private/qoauth1_p.h
/usr/include/qt5/QtNetworkAuth/5.12.4/QtNetworkAuth/private/qoauth1signature_p.h
/usr/include/qt5/QtNetworkAuth/5.12.4/QtNetworkAuth/private/qoauth2authorizationcodeflow_p.h
/usr/include/qt5/QtNetworkAuth/5.12.4/QtNetworkAuth/private/qoauthhttpserverreplyhandler_p.h
...
/usr/lib64/libQt5NetworkAuth.so.5.12.4
